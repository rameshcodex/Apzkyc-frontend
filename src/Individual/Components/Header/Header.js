                ...
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        {matches && <div className="indi-h-lgo cursor" onClick={(() => { navigate('/individual/kyc') })}>
                            <img src={consts.projectDashborad} alt="logo" />
                        </div>}
